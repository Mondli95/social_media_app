        ...
        <div className='rightBar'>
            <div className="container">
                ...
                <div className="item">
                    ...
                    <div className="user">
                        <div className="userInfo">
                            ...
                            <p>
                                <span>Jack Black</span> changed profile picture
                            </p>
                        </div>
                    ...
                    <div className="user">
                        <div className="userInfo">
                            <img src="https://images.pexels.com/photos/4881619/pexels-photo-4881619.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
                            <p>
                                <span>isaac Jacobs</span> liked you post
                            </p>
                        </div>
                        <span className='time'>1 minute ago</span>
                    </div>
                    <div className="user">
                        <div className="userInfo">
                            <img src="https://images.pexels.com/photos/4881619/pexels-photo-4881619.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
                            <p>
                                <span>Hlengiwe Shozi</span> liked your post
                            </p>
                        </div>
                        <span className='time'>1 minute ago</span>
                    </div>
                    <div className="user">
                        <div className="userInfo">
                            <img src="https://images.pexels.com/photos/4881619/pexels-photo-4881619.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
                            <p>
                                <span>Themba Brolly</span> changed his profile picture
                            </p>
                        </div>
                        <span className='time'>1 minute ago</span>
                    </div>
                ...
                <div className="item">
                    ...
                    <div className="user">
                        <div className="userInfo">
                            <img src="https://images.pexels.com/photos/4881619/pexels-photo-4881619.jpeg?auto=compress&cs=tinysrgb&=1600" alt="" />
                            <div className="online" />
                            <span>Simon Davids</span>
                        </div>
                    </div>
                    <div className="user">
                        <div className="userInfo">
